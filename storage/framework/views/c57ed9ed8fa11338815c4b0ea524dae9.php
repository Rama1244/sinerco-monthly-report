...
<?php $__env->startSection('desc', 'Halaman untuk melihat hasil Monthly Report yang telah anda input'); ?>
<?php $__env->startSection('content'); ?>
<div class="container-xl px-4 mt-n10">
    <div class="row">
        <div class="col-xxl-8 col-xl-8 col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body h-100 p-5">
                    <div class="row align-items-center">
                        <div class="col-xl-8 col-xxl-12">
                            <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                <h1 class="text-primary">Selamat datang di <i>Monthly Report Online</i> SINERCO!</h1>
                                <p class="text-gray-700 mb-0">Anda dapat melaporkan semua hasil yang terjadi pada lapangan!</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid" src="<?php echo e(asset('assets/img/work-ilustration.svg')); ?>" style="max-width: 26rem" /></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-header">
                    ...
                    <div class="dropdown no-caret">
                        ...
                        <div class="dropdown-menu dropdown-menu-end animated--fade-in-up" aria-labelledby="dropdownMenuButton">
                            <h6 class="dropdown-header">Keterangan:</h6>
                            <a class="dropdown-item" href="#!"><span class="badge bg-yellow-soft text-yellow my-1">Standby</span></a>
                            <a class="dropdown-item" href="#!"><span class="badge bg-red-soft text-red my-1">Shut down</span></a>
                        ...
                        <?php $__currentLoopData = $remarksReport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="timeline-item">
                                <div class="timeline-item-marker">
                                    <!-- menghitung lama waktu dari start remarks sampai end remarks -->
                                    <div class="timeline-item-marker-text">
                                        <?php
                                            $awal = strtotime($rr->remarks_start);
                                            $akhir = strtotime($rr->remarks_end);
                                ...
                                <div class="timeline-item-content">
                                    <?php echo e($rr->condition); ?> - <?php echo e($rr->id_lapangan); ?> <?php echo e($rr->remarks); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sinerco-monthly-report\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>